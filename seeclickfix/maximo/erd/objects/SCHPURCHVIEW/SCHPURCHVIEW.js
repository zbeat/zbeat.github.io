mos = {
    "objectName": "SCHPURCHVIEW",
    "className": "psdi.app.contract.schedule.SchPurchViewSet",
    "description": "Purchasing contract view for SCHEDULE.",
    ...
    "viewinfo": {
        "autosect": true,
        "viewwhere": "scheduletype in (select value from synonymdomain where domainid ='SCHEDULETYPE' and maxvalue = 'PURCH')"
    },
