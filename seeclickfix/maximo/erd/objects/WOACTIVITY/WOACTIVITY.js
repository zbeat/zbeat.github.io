mos = {
    ...
    "className": "psdi.app.workorder.WOActivitySet",
    "description": "The WOACTIVITY view.",
    ...
    "columns": [
        {
            ...
            "persistent": true,
            "title": "Activity",
            "remarks": "Identifies the work order number.",
        ...
        },
        {
            ...
            "persistent": false,
            "title": "Estimated Material Cost",
            "remarks": "Estimated total cost of the work order at the time of approval.",
        ...
        },
        {
            ...
            "persistent": false,
            "title": "SLA Applied",
            "remarks": "Specifies whether an SLA has been applied. If the check box is selected, an SLA has been applied. If the check box is cleared (the default), no SLA has been applied.",
        ...
        {
            "attributeName": "PARENTPROCESS",
            "required": false,
            "persistent": false,
            "title": "Parent Process",
            "remarks": "Parent Process associated with activity/task",
            "sameAsAttribute": "WONUM",
            "sameAsObject": "WORKORDER"
        },
        {
    ...
    "viewinfo": {
        "autosect": true,
        "viewwhere": "woclass in (select value from synonymdomain where domainid='WOCLASS' and maxvalue= 'ACTIVITY' )"
    },
